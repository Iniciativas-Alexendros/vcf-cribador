...
**Nota (v0.5.x, docs):** modernización del design system de la GUI (OKLCH tokenizado → GUI profesional) — plan en [`docs/gui/design-system-plan.md`](./docs/gui/design-system-plan.md), epic [#59](https://github.com/Iniciativas-Alexendros/zedazo/issues/59). **Fase 1** (pipeline DTCG → CSS/TS + contraste CI, [ADR-0019](./DECISIONS.md)) aterrizada; fases 2–4 en PRs posteriores, **separados** de CardDAV ([#48](https://github.com/Iniciativas-Alexendros/zedazo/issues/48)).
